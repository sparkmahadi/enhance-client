...
const Home = () => {
    ...
    return (
        <div className='px-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-10 lg:px-8 my-5'>
            ...
            <div data-aos="flip-left" data-aos-duration="2000" className='my-10'>
            ...
            <div data-aos="fade-right" data-aos-duration='1000' className='py-5 text-gray-100 rounded-lg mb-10'>
            ...
            <section className=" text-gray-100 rounded-lg mb-10">
                ...
                <div data-aos='fade-left' data-aos-duration='1000' className="container py-6 mx-auto space-y-8">
